...
<div class="container">
    ...
    <div class="row">
            ...
            <ul class="list-group mb-3">
                <?php foreach ($cartProducts as $product) { ?>
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">$<?php echo $product['product_price'] * $product['quantity']; ?></span>
                    </li>
                <?php } ?>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" method="post" action="/validateOrder">
                <div class="row">
                ...
                <input type="hidden" name="items" value="<?php echo htmlspecialchars(json_encode($cartProducts)); ?>">
